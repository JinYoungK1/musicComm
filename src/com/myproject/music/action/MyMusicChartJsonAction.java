...
public class MyMusicChartJsonAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("M : MyMusicChartJsonAction_execute() 호출");
		...
		musicList = dao.getChartList(startRow, pageSize);
